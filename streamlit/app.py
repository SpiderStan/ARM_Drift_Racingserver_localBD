...
from pages import pre_mainpage, mainpage, create_lobby, select_lobby, delete_lobby, create_race_game, create_lap_race_game, create_time_race_game, create_elimination_game, create_gymkhana_game, create_gymkhana_training, create_stagerace_config, create_pre_stagerace_game, create_stagerace_game, select_race, delete_race, racedisplay, lapracedisplay, timeracedisplay, eliminationracedisplay, sectordisplay, stage_racedisplay, gymkhana_training_racedisplay, download_race, download_laprace, download_timerace, download_eliminationgame, download_stagerace, remove_player_from_race, remove_player_from_stage_part1, remove_player_from_stage_part2, reset_stage, statistics, statistics_stage, download_statistics, highscore_list, remove_player_from_highscore_list, system_settings # import your pages here
...
# Add all your applications (pages) here
    ...
    app.add_page("create_elimination_game", create_elimination_game.app)
    ...
    app.add_page("eliminationracedisplay", eliminationracedisplay.app)
    ...
    app.add_page("download_eliminationgame", download_eliminationgame.app)
