...
def app():
    ...
    track_id = [""] * 20
    time_limit_enabled = [False] * 20
    time_limit = [None] * 20
    lap_limit_enabled = [False] * 20
    lap_count = [None] * 20
    track_condition_enabled = [False] * 20
    track_condition_selected = [None] * 20
    track_bundle_enabled = [False] * 20
    track_bundle_selected = [None] * 20
    wheels_enabled = [False] * 20
    wheels_selected = [None] * 20
    setup_mode_enabled = [False] * 20
    setup_mode_selected = [None] * 20
    joker_lap_enabled = [False] * 20
    joker_lap_precondition_enabled = [False] * 20
    joker_lap_code = [None] * 20
    joker_lap_precondition_code = [None] * 20
    bonus_target_set = [False] * 20
    bonus_target_selected = [None] * 20
