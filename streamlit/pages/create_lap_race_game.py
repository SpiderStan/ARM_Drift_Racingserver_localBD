...
def app():
    ...
    st.subheader("Create new Lap Race Game in Lobby " + str(lobby_id))
    ...
    with placeholder1.container():
        with st.form("my_form", clear_on_submit=True):
            gameOptions = {}
            game_id = st.text_input("Game ID", value="Lap1", max_chars=None, key=None, type="default", help=None, autocomplete=None, on_change=None, disabled=False)
